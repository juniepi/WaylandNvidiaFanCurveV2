...
**This issue has also seemed to be fixed *hopefully* but we had to end up changing the code to match the V1 script a little bit so please refere to the original WNFC project to setup your fan curves! IF YOU CONTIUNE HAVING PROBLEMS PLEASE RESORT THE THE VERSION ONE SCRIPT FOUND [HERE](https://github.com/juniepi/WaylandNvidiaFanCurve)**
